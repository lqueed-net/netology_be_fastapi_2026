...
async def get_students(
        ...
        min_age: Optional[int] = Query(None, ge=16, le=30, description='Минимальный возраст'),
        max_age: Optional[int] = Query(None, ge=16, le=30, description='Максимальный возраст'),
):
